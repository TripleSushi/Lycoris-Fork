...
function FiniteStateMachine:get(identifier)
	...
	return error(string.format("(%s) State does not exist in states table.", identifier))
end
...
function FiniteStateMachine:stop()
	...
	if not self.started then
		return error("Finite state machine has not been started.")
	end
...
function FiniteStateMachine:start()
	...
	if self.started then
		return error("Finite state machine has already been started.")
	end
